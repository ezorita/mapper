...
SOURCE_FILES= mapper.c indexquery.c algs.c seed.c filter.c format.c #mapper-main.c bwmapper.c hitmap.c  poucet.c
HEADER_FILES= mapper.h indexquery.h algs.h seed.h filter.h format.h #bwmapper.h hitmap.h poucet.h definitions.h
