...
SOURCE_FILES= mapper.c indexquery.c algs.c seed.c filter.c format.c annotate.c xxhash.c
HEADER_FILES= mapper.h indexquery.h algs.h seed.h filter.h format.h index.h annotate.h xxhash.h
